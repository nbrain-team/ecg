    ...
    try {
      ...
      const proposalPayload = {
        ...
        eventDetails: {
          ...
          flexibleDateRange: state.program.is_flexible && state.program.flex_start && state.program.flex_end 
            ? `${state.program.flex_start} to ${state.program.flex_end}`
            : undefined,
          doubleOccupancy: state.occupancy.is_double_majority,
          doublePct: state.occupancy.double_pct,
          roomView: state.rooms.view_pref,
          roomViewPct: state.rooms.view_pct,
