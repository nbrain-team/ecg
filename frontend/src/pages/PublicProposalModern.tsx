...
function PublicProposalModern() {
  ...
  const eventSubtitle = `${formatDate(proposal.eventDetails.startDate)} - ${formatDate(proposal.eventDetails.endDate)} • ${proposal.eventDetails.attendeeCount} Attendees`;
    ...
    <div>
      ...
      <header className="proposal-header">
        ...
        <div className="header-content">
          ...
          <h2 className="event-name">{proposal.eventDetails.name}</h2>
                ...
                <div className="room-images">
                  ...
                  <div className="room-thumbnails">
                    <div className="room-thumbnail">
                      <img src={room.images?.[1] || room.images?.[0] || ''} alt={`${room.name} alt view`} />
                    </div>
                    <div className="room-thumbnail">
                      <img src={room.images?.[2] || room.images?.[0] || ''} alt={`${room.name} amenities`} />
                    </div>
                  </div>
                </div>
